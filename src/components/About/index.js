...
function About() {
  return (
    <section>
      ...
      <h1 id="about" class="has-text-centered is-size-2 has-text-weight-bold">About Me</h1>
      <div class="is-flex is-horizontal-center">
      <img src={coverImage} style={{ width: "30%" }}  alt="cover" />
      </div>
      <div>
        <p class="box" style={{width: 900, margin: "auto"}}>
